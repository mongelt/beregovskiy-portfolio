    ...
    <div className="min-h-screen bg-[#1a1d23] text-white flex flex-col relative">
      ...
      <div className="flex-1 px-8 pt-3 pb-6 overflow-hidden">
        <div className="max-w-7xl mx-auto flex justify-between items-start h-full">
          ...
          <div className="flex-shrink-0 flex gap-12 items-start bg-[#1a1d23] p-4 relative z-10">
            {/* Column 1 */}
            <div className="space-y-3">
              <div className="text-gray-500">Category</div>
              <div className="text-gray-500">Category 2</div>
              <div className="text-gray-500">Category 3</div>
              <div className="text-gray-500">Category 4</div>
              <div className="text-gray-500">Category 5</div>
            </div>
            
            {/* Column 2 */}
            <div className="space-y-3">
              <div className="text-gray-500">Subcategory</div>
              <div className="text-gray-500">Subcategory 2</div>
              <div className="text-gray-500">Subcategory 3</div>
            </div>
            
            {/* Column 3 */}
            <div className="space-y-3">
              <div className="text-[#00ff88]">Content item</div>
              <div className="text-gray-500">Content item 2</div>
              <div className="text-gray-500">Content item 3</div>
              <div className="text-gray-500">Content item 4</div>
              <div className="text-gray-500">Content item 5</div>
            </div>
          </div>
          ...
          <div className="flex-shrink-0 bg-[#1a1d23] p-4">
            <div className="space-y-3">
              ...
              <div className="text-gray-500">Collection 6</div>
              <div className="text-gray-500">Collection 7</div>
            </div>
          </div>
        </div>
      </div>
